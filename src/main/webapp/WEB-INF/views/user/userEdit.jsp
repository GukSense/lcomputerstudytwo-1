	    ...
	    <div class="wrap">                
	        <div class="user">                    
	            ...
	            <div class="form-wrap">
	                <!-- TABS -->
	                <div class="tabs">
						<h3 class="signup-tab"><a class="sign-up" href="#signup-tab-content"><span>User Edit</span></a></h3>
	                </div>
	                  <!-- TABS CONTENT -->
	              	<div class="tabs-content">
	                	...
	                	<div id="login-tab-content" class="active">
	                  		<form action="/user/userEdit" method="post">
								...
								<div class="input">
								<p>	권한: <input type="radio" name="checkedAuthorities" value="ROLE_ADMIN,ROLE_USER" style="margin-left: 15px;
" >관리자	 <!-- 사용이유 : radio로는 value 값을 여러개 보낼수없어서 받아오는쪽에서 값을 나누기로 결정 -->
										<input type="radio" name="checkedAuthorities" value="ROLE_USER" style="margin-left: 15px"> 일반
								</p>	
								</div>
